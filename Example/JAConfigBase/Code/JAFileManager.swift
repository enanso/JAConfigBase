//
//  JAFileManager.swift
//  JAConfigBase_Example
//
//  Created by Qiyeyun7 on 2021/8/6.
...
class JAFileManager: NSObject {
    ...
    /// - Returns: 编码结果
    public static func md5String(_ string: String?, lower: Bool) -> String? {
    ...
    /// - Returns: 编码结果
    public static func base64String(_ string: String?, encode: Bool) -> String? {
        if encode { // 编码
    ...
    public static func sha1String(_ string: String?) -> String? {
        guard let codingData = string?.data(using: .utf8) else {
            return nil
        }
    ...
    public static func shaCrypt(string: String?, cryptType: SHAType, key: String?, lower: Bool) -> String? {
    ...
    public static func scaCrypt(string: String?, cryptType: SCAType, key: String?, encode: Bool) -> String? {
